        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    HomeCountry = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ShortBio = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Campus = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    MajorFieldOfStudy = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    ...
                    MatchingPreference = table.Column<int>(type: "integer", nullable: false),
                    Languages = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    RsvpAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistItems_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChecklistItems_Users_CompletedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupIcebreakers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupIcebreakers_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistItems_GroupId",
                table: "ChecklistItems",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupIcebreakers_GroupId",
                table: "GroupIcebreakers",
                column: "GroupId");
